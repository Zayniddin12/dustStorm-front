<template>
  <div class="bg-white p-5 rounded-28 border border-dark-300/10 w-[280px] min-h-[220px] flex flex-col">
    <div class="flex-center bg-primary size-12 rounded-xl shadow-card">
      <span class="icon-file text-white text-[28px]"></span>
    </div>
    <p class="font-normal text-20 leading-130 text-dark-100 my-4 line-clamp-2 overflow-hidden text-ellipsis">
      {{ report.title }}
    </p>
    <div class="mt-auto">
